      ...
      <section className="footer-Content py-5 px-2 bg-transparent d-flex justify-content-evenly">
        ...
        <div className="footer-Contact mb-4 mt-3 mt-md-0 mb-md-0">
          ...
          <p className="d-flex align-items-center gap-2">
            ...
            <a href="https://maps.app.goo.gl/FM52Yyiv4gvhG7b28" target="_blank">
              Ubicacion. Pais
            </a>
          </p>
          <p className="d-flex align-items-center gap-2">
            ...
            <Link to="/404" onClick={() => scrollToTop("/404")}>
              +3815293845
            </Link>
          </p>
          <p className="d-flex align-items-center gap-2">
            ...
            <Link to="/404" onClick={() => scrollToTop("/404")}>paradiseresort@gmail.com</Link>
          </p>
        </div>
        <div className="footer-Links text-light">
          ...
          <ul className="d-flex flex-column gap-2 p-0 ">
            <li className="d-flex align-items-center gap-2">
              ...
              <Link to="/nosotros" onClick={() => scrollToTop("/nosotros")}>Sobre Nosotros</Link>
            </li>
            <li className="d-flex align-items-center gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <li className="d-flex align-items-center gap-2">
              ...
              <Link to="/404" onClick={() => scrollToTop("/404")}>Privacidad</Link>
            </li>
            <li className="d-flex align-items-center gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <Link to="/404" onClick={() => scrollToTop("/404")}>Terminos y condiciones</Link>
            </li>
          </ul>
        </div>
        <div className="footer-SocialMedia text-light">
          ...
          <ul className="list-unstyled d-flex flex-column gap-2 ">
            <li className="d-flex align-items-center gap-2">
              ...
              <Link to="/404" onClick={() => scrollToTop("/404")}>Facebook</Link>
            </li>
            <li className="d-flex align-items-center gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <Link to="/404" onClick={() => scrollToTop("/404")}>Twitter</Link>
            </li>
            <li className="d-flex align-items-center gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <Link to="/404" onClick={() => scrollToTop("/404")}>Instagram</Link>
            </li>
          </ul>
        </div>
      </section>
