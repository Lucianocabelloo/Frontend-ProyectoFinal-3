...
const Footer = () => {
    ...
    <Container fluid className='footer-Container'>
      <section className='footer-Content py-5 bg-transparent d-flex justify-content-evenly'>
        <div className='footer-Description'>
          ...
          <p>
            En el corazón de Costa Serena, entre las olas que acarician la playa y los árboles que susurran secretos antiguos, nació Paradise Hotel Resort. Desde 2010, hemos sido un refugio de lujo donde el océano y la selva convergen para brindarte una experiencia inolvidable.
          </p>
        </div>
        <div className='footer-Contact'>
          ...
          <p className='d-flex align-items-center gap-2'>
            ...
            <Link to="/404">Ubicacion. Pais</Link>
          </p>
          <p className='d-flex align-items-center gap-2'>
  ...
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0M5.496 6.033h.825c.138 0 .248-.113.266-.25.09-.656.54-1.134 1.342-1.134.686 0 1.314.343 1.314 1.168 0 .635-.374.927-.965 1.371-.673.489-1.206 1.06-1.168 1.987l.003.217a.25.25 0 0 0 .25.246h.811a.25.25 0 0 0 .25-.25v-.105c0-.718.273-.927 1.01-1.486.609-.463 1.244-.977 1.244-2.056 0-1.511-1.276-2.241-2.673-2.241-1.267 0-2.655.59-2.75 2.286a.237.237 0 0 0 .241.247m2.325 6.443c.61 0 1.029-.394 1.029-.927 0-.552-.42-.94-1.029-.94-.584 0-1.009.388-1.009.94 0 .533.425.927 1.01.927z"/>
                            ...
                            <Link to="/404">Privacidad</Link></li>
              <li className='d-flex align-items-center gap-2'>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-info-square" viewBox="0 0 16 16">
  <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/>
  <path d="m8.93 6.588-2.29.287-.082.38.45.083c.294.07.352.176.288.469l-.738 3.468c-.194.897.105 1.319.808 1.319.545 0 1.178-.252 1.465-.598l.088-.416c-.2.176-.492.246-.686.246-.275 0-.375-.193-.304-.533zM9 4.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0"/>
</svg>
<Link to="/404">Terminos y condiciones</Link></li>
          </ul>
        </div>
